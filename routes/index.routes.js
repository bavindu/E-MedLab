...
router.get('/getAllTestRecord',jwtHelper.jwtVerify,ctrlTestRocord.getAllTestRecord);
router.get('/getAllPatients',jwtHelper.jwtVerify,ctrlUser.getAllPatients);
router.post('/getPatient',jwtHelper.jwtVerify,ctrlUser.getPatient);
router.post('/getPatientsTestRecords',jwtHelper.jwtVerify,ctrlTestRocord.getPatientsTestRecords);
router.post('/deleteTestRecord',jwtHelper.jwtVerify,ctrlTestRocord.deleteTestRecord);
