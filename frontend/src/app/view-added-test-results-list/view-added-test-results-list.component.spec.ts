...
import { ViewAddedTestResultsListComponent } from './view-added-test-results-list.component';
...
describe('ViewAddedTestResultsListComponent', () => {
  let component: ViewAddedTestResultsListComponent;
  let fixture: ComponentFixture<ViewAddedTestResultsListComponent>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(ViewAddedTestResultsListComponent);
