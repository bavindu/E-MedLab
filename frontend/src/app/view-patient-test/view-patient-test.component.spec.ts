...
import { ViewPatientTestComponent } from './view-patient-test.component';
...
describe('ViewPatientTestComponent', () => {
  let component: ViewPatientTestComponent;
  let fixture: ComponentFixture<ViewPatientTestComponent>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(ViewPatientTestComponent);
